...
### Key bug fixes and changes
  ...
  - Added new form input sizes based on the Bootstrap grid system (meaning now you can do `input.col-span-5` for a 280px-wide input)
...
- **Simplified the grid CSS** by removing the static .col-span-1-16 classes in favor of CSS-style regex for column styles in the grid
