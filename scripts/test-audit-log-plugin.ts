...
function hookHandler(entry) {
	assert.ok(entry, "Expected audit log hook to exist");
...
assert.equal(typeof beforeSaveHook, "function");
assert.equal(typeof afterSaveHook, "function");
