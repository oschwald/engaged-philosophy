...
<section id="primary" class="col-span-8">
	...
	<div id="content" role="main">
		...
		if ( have_posts() ) :
			...
			<div id="author-info" class="row">
				<h2 class="col-span-8"><?php printf( __( 'About %s', 'the-bootstrap' ), get_the_author() ); ?></h2>
				<div id="author-avatar" class="col-span-1">
					<?php echo get_avatar( get_the_author_meta( 'user_email' ), apply_filters( 'the-bootstrap_author_bio_avatar_size', 70 ) ); ?>
				</div><!-- #author-avatar -->
				<div id="author-description" class="col-span-7">
