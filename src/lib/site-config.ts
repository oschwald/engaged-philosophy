...
export const SITE_TIMEZONE_FALLBACK = "America/Los_Angeles";
export const SITE_DATE_FORMAT_FALLBACK = "MMMM d, yyyy";
export const CLOUDFLARE_ACCESS_TEAM_DOMAIN =
	"engaged-philosophy.cloudflareaccess.com";
export const PUBLIC_EDGE_CACHE_MAX_AGE_SECONDS = 86_400;
export const PUBLIC_EDGE_CACHE_SWR_SECONDS = 3_600;
